...
TARGET = $(TARGETDIR)/Tetris
OBJDIR = obj/x64/Debug_RGFW/Tetris
DEFINES += -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -Wshadow -std=c99 -Wno-deprecated-declarations
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -Wshadow -std=c++17 -Wno-deprecated-declarations
...
TARGETDIR = ../../bin/Debug_RGFW
TARGET = $(TARGETDIR)/Tetris
OBJDIR = obj/x86/Debug_RGFW/Tetris
DEFINES += -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -std=c99 -Wno-deprecated-declarations
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -std=c++17 -Wno-deprecated-declarations
LIBS += ../../bin/Debug_RGFW/libraylib.a -framework OpenGL -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreAudio -framework CoreVideo -framework AudioToolbox
LDDEPS += ../../bin/Debug_RGFW/libraylib.a
ALL_LDFLAGS += $(LDFLAGS) -m32
...
TARGETDIR = ../../bin/Debug_RGFW
TARGET = $(TARGETDIR)/Tetris
OBJDIR = obj/ARM64/Debug_RGFW/Tetris
DEFINES += -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -Wshadow -std=c99 -Wno-deprecated-declarations
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -Wshadow -std=c++17 -Wno-deprecated-declarations
LIBS += ../../bin/Debug_RGFW/libraylib.a -framework OpenGL -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreAudio -framework CoreVideo -framework AudioToolbox
LDDEPS += ../../bin/Debug_RGFW/libraylib.a
ALL_LDFLAGS += $(LDFLAGS)
...
TARGET = $(TARGETDIR)/Tetris
OBJDIR = obj/x64/Release_RGFW/Tetris
DEFINES += -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -Wshadow -std=c99 -Wno-deprecated-declarations
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -Wshadow -std=c++17 -Wno-deprecated-declarations
...
TARGETDIR = ../../bin/Release_RGFW
TARGET = $(TARGETDIR)/Tetris
OBJDIR = obj/x86/Release_RGFW/Tetris
DEFINES += -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -std=c99 -Wno-deprecated-declarations
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m32 -Wshadow -std=c++17 -Wno-deprecated-declarations
LIBS += ../../bin/Release_RGFW/libraylib.a -framework OpenGL -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreAudio -framework CoreVideo -framework AudioToolbox
...
TARGETDIR = ../../bin/Release_RGFW
TARGET = $(TARGETDIR)/Tetris
OBJDIR = obj/ARM64/Release_RGFW/Tetris
DEFINES += -DPLATFORM_DESKTOP_RGFW -DGRAPHICS_API_OPENGL_33
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -Wshadow -std=c99 -Wno-deprecated-declarations
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -Wshadow -std=c++17 -Wno-deprecated-declarations
LIBS += ../../bin/Release_RGFW/libraylib.a -framework OpenGL -framework Cocoa -framework IOKit -framework CoreFoundation -framework CoreAudio -framework CoreVideo -framework AudioToolbox
